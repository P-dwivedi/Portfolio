  ...
  return (
    ...
    >
        ...
        <div className='relative'>
            ...
            {/* Experience Added Part */}
            {experiences.map((experience, index) => (
                <div
                key={experience.id}
                className={`flex flex-col sm:flex-row items-center mb-16 ${index % 2 === 0 ? "sm:justify-end" : "sm:justify-start"}`}
                >
                    <div className='absolute sm:left-1/2 left-0 transform -translate-x-1/2 bg-gray-400 border-4 border-[#006666] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10'>
                        <img
                        src={experience.img}
                    ...
                    <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(0,102,102,0.8)] 
                        ...
                        <div className='mt-4'>
                            ...
                            <ul className='flex flex-wrap mt-2'>
                                {experience.skills.map((skill, index) => (
                                    <li 
                                    key={index}
                                    className='bg-[#006666] text-gray-300 px-4 py-1 text-xs sm:text-sm rounded-lg mr-2 mb-2 border border-gray-400'
                                    >{skill}</li>
                                ))}
                            </ul>
                        </div>
